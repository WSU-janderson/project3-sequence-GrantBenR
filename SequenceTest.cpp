...
const int TEST_INT_ARR[5] = {1, 2, 3, 4, 5};
const int TEST_INT_ARR_SIZE = 5;
...
bool SequenceTest::TEST_S_push_back_string()
{
    ...
    std::cout << "Sequence before push_back: " << *test_sequence << std::endl;
...
bool SequenceTest::TEST_S_last_index()
{
    ...
    const Sequence* test_sequence = new Sequence(TEST_INT_ARR, TEST_INT_ARR_SIZE);
