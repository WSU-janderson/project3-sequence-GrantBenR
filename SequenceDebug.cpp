...
bool SequenceDebug::TEST_Sequence()
{
...
bool SequenceDebug::TEST_Sequence_size_t()
{
...
bool SequenceDebug::TEST_Sequence_deepcopy()
{
...
bool SequenceDebug::TEST_set_size_size_t()
{
...
bool SequenceDebug::TEST_set_size_int()
{
...
bool SequenceDebug::TEST_get_head()
{
...
bool SequenceDebug::TEST_set_head()
{
...
bool SequenceDebug::TEST_get_tail()
{
...
bool SequenceDebug::TEST_set_tail()
{
...
bool SequenceDebug::TEST_tilde_Sequence()
{
    std::cout << "- - Sequence::~Sequence() - - " << std::endl;
    Sequence* test_sequence = new Sequence(5);
    ~test_sequence;
...
bool SequenceDebug::TEST_operator_equals()
{
...
bool SequenceDebug::TEST_operator_brackets()
{
...
bool SequenceDebug::TEST_push_back_string()
{
...
bool SequenceDebug::TEST_push_back_int()
{
...
bool SequenceDebug::TEST_pop_back()
{
...
bool SequenceDebug::TEST_insert_string()
{
...
bool SequenceDebug::TEST_insert_int()
{
...
bool SequenceDebug::TEST_erase_count()
{
    std::cout << "- - Sequence::erase(size_t position) - - " << std::endl;
    Sequence* test_sequence = new Sequence(0);
    for (int i = 0; i < 5; i++) {
...
bool SequenceDebug::TEST_last_index()
{
...
bool SequenceDebug::TEST_operator_ostream()
{
